import 'dart:async';
  ...
  final feedProvider = FutureProvider.autoDispose<List<Map<String, dynamic>>>((ref) async {
          ...
          itemBuilder: (_, __) => Column(
            ...
            children: [
              ...
              const MLoadingSkeleton(
                  width: double.infinity, height: 260, borderRadius: 0),
              const Padding(
  ...
  class _PostCardState extends ConsumerState<_PostCard>
    ...
    void _doubleTapLike() {
      ...
      _heartAnim
          .forward(from: 0)
          .then((_) => setState(() => _showHeart = false));
    }
    ...
    Widget build(BuildContext context) {
      ...
      final displayName =
          (widget.post['displayName'] ?? username).toString();
      final avatarUrl = widget.post['avatarUrl'] as String?;
      final mediaUrls = widget.post['mediaUrls'] as List?;
      final imageUrl =
